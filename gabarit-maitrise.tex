...
\newglossaryentry{Pk}{name={$\mathbf{P}(k \mid k)$}, description={estimates of the state estimation error covariance at time $k$ made with information available at time $k$}}
