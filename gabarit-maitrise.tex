...
\newglossaryentry{rk}{name={$\mathbf{r}(k)$}, description={the mode number of a switching system at time $k$}}
...
\newglossaryentry{Gammafkmnk}{name={$\Gamma_m(k-N_f+1,k)$}, description={shock indicator hypotheses sequence $f$ from time $k-N_f+1$ to $k$}}
