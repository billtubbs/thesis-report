...
%% disponibles.
%%
%% [Ne pas hésiter à supprimer les commentaires après les avoir lus.]\textbf{}
%%
...
%% défaut du document.
\documentclass[MSc,french,english]{ulthese}
...
\makenomenclature
% NOTE: To update the nomenclature need to run a custom user command. 
% In TexStudio I set this up as Tools -> User -> 1. Make Nomenclature.
