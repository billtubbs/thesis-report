...
\newglossaryentry{RMSE}{name=\ensuremath{\mathrm{RMSE}}, description={root-mean-squared error}}
...
\newglossaryentry{rmk}{name=\ensuremath{\mathbf{r}_m(k)}, description={indicator of the system modes of the merged hypotheses at time $k$ used at time $k$ in branching and merging operations}}
...
\newglossaryentry{SNR}{name=\ensuremath{\mathrm{SNR}}, description={Signal-to-noise ratio}}
...
% Future work
\newglossaryentry{SMC}{name={SMC}, description={sequential Monte Carlo}}
...
%  }
 ...
 \bibliographystyle{apalike}
  ...
  \titre{Process Observers for Detecting Ore Feed Disturbances in Grinding Operations}
