...
% General notation
\newglossaryentry{qm1}{name=\ensuremath{q^{-1}}, description={backwards shift operator}}
...
\newglossaryentry{wk}{name=\ensuremath{\mathbf{w}(k)}, description={process disturbance signals at time $k$}}
\newglossaryentry{vk}{name=\ensuremath{\mathbf{v}(k)}, description={measurement noise signals at time $k$}}
...
\newglossaryentry{nj}{name=\ensuremath{n_j}, description={the number of modes or models of a switching system}}
\newglossaryentry{rk}{name=\ensuremath{\mathbf{r}(k)}, description={mode indicator of a switching system at time $k$ (scalar or vector)}}
...
\newglossaryentry{AG}{name={AG},description={autogenous grinding mill}}
\newglossaryentry{MPC}{name={MPC},description={model predictive control}}
\newglossaryentry{PI}{name={PI},description={proportional-integral (control)}}
\newglossaryentry{PID}{name={PID},description={proportional-integral-derivative (control)}}
...
\newglossaryentry{MJLS}{name={MJLS},description={Markov jump linear system}}
\newglossaryentry{EKF}{name={EKF},description={extended Kalman filter}}
\newglossaryentry{ARIMA}{name={ARIMA},description={autoregressive integrated moving average}}
\newglossaryentry{kWh}{name={kWh},description={kilowatt-hours}}
\newglossaryentry{MLE}{name={MLE},description={maximum likelihood estimation}}

% Disturbance models
\newglossaryentry{RODD}{name={RODD}, description={randomly-occurring deterministic disturbance}}
\newglossaryentry{epsilon}{name=\ensuremath{\epsilon}, description={probability of a random shock}}
...
\newglossaryentry{b}{name=\ensuremath{b}, description={ratio of the variance of the shocks and the noise component of the random shock process}}
...
\newglossaryentry{Sk}{name=\ensuremath{\mathbf{S}(k)}, description={covariance of the output prediction errors}}
\newglossaryentry{Sfk}{name=\ensuremath{\mathbf{S}_f(k)}, description={covariance of the output prediction errors of Kalman filter $f$}}
...
\newglossaryentry{Qset}{name=\ensuremath{\mathcal{Q}}, description={set of process noise covariance matrices for a switching system}}
\newglossaryentry{Qk}{name=\ensuremath{\mathbf{Q}(k)}, description={covariance of the process disturbances in the observer model}}
...
\newglossaryentry{RMSD}{name={RMSD}, description={root-mean-squared differences}}

% Grinding simulator
\newglossaryentry{PSD}{name={PSD}, description={particle size distribution}}
\newglossaryentry{P80}{name={P80}, description={80\% passing size, a measure of a particle size distribution}}

% Multiple model approaches
\newglossaryentry{MKF}{name={MKF}, description={multiple-model Kalman filter}}
\newglossaryentry{GPB}{name={GPB}, description={generalised pseudo-Bayesian estimator}}
...
\newglossaryentry{nf}{name=\ensuremath{N_f}, description={sequence fusion parameter: length of fusion horizon in number of sample periods}}
\newglossaryentry{m}{name=\ensuremath{n_\text{max}}, description={sequence fusion parameter: maximum number of shock occurences within the fusion horizon}}
\newglossaryentry{d}{name=\ensuremath{N_d}, description={sequence fusion parameter: shock spacing parameter or length of detection interval, in number of sample periods}}
...
\newglossaryentry{epsilond}{name=\ensuremath{\epsilon_d}, description={sequence fusion parameter: probability of at least one shock within the detection interval}}
...
% Simulations
\newglossaryentry{PRBS}{name={PRBS}, description={Pseudo-random binary sequence}}
...
\newglossaryentry{Nset95}{name=\ensuremath{N_{\pm5\%}}, description={settling time of the process to within $\pm5\%$ of steady-state, measured in number of sample periods}}
\newglossaryentry{Tp1}{name=\ensuremath{T_{p,1}}, description={adjustable time constant of the process model, used in sensitivity analysis}}
\newglossaryentry{Kp}{name=\ensuremath{K_p}, description={adjustable gain of the process model, used in sensitivity analysis}}
...
\newglossaryentry{PRNG}{name={PRNG}, description={pseudo-random number generator}}
