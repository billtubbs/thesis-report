...
\newglossaryentry{rmk}{name={$\mathbf{r}_m(k \mid k)$}, description={indicator of the system modes of the merged hypotheses at time $k$ used at time $k$ in branching and merging operations}}
\newglossaryentry{rbk}{name={$\mathbf{r}_b(k \mid k)$}, description={indicator of the system modes of the branched hypotheses at time $k$ used at time $k$ in branching and merging operations}}
\newglossaryentry{rbkp1}{name={$\mathbf{r}_b(k+1 \mid k)$}, description={indicator of the system modes of the branched hypotheses at time $k+1$ used at time $k$ in branching and merging operations}}
