...
\newglossaryentry{DOB}{name={DOB},description={disturbance observer based (control)}}
\newglossaryentry{LQG}{name={LQG},description={linear quadratic Gaussian (control)}}
\newglossaryentry{GMM}{name={GMM},description={Gaussian mixture model}}
\newglossaryentry{EM}{name={EM},description={expectation maximisation}}
