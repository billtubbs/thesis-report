...
\begin{table}[hb]
	...
	\end{center}
\end{table}
\hl{For the sequence pruning algorithm, the best combination of parameters, $n_h=61$ and $N_\text{min}=29$, was chosen}. A summary of all the parameter values used in the MIMO simulations is included in Table \ref{tb:obs-params-sim2} in the main body of the report.
